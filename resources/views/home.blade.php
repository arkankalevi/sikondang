...
<html lang="en">
    <head>
        ...
        <link href="home/img/logo.png" rel="logo">
...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        ...
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
          ...
          <a class="btn-getstarted" href="#organisasi">Login</a>
        ...
        <div class="container">
          <div class="row gy-4">
            <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
              <h1>SIKONDANG</h1>
              <p>Sistem Informasi Kota Serang Dalam Angka</p>
              <div class="d-flex">
                <a href="#services" class="btn-get-started">Selanjutnya</a>
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-4 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Statistik Sektoral</a></h4>
          ...
          <div class="col-xl-4 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="300">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Perencanaan</a></h4>
          ...
          <div class="col-xl-4 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="400">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Geospasial - Kota Serang</a></h4>
...
<section id="counts" class="counts">
  ...
  <footer id="footer" class="footer">
      ...
      <div class="row gy-4">
        <div class="col-lg-5 col-md-6 footer-about">
          <a href="index.html" class="d-flex align-items-center">
            <span class="sitename">SIKONDANG</span>
          </a>
          <div class="footer-contact pt-3">
            <p>Jl. Jend. Sudirman No.25, Banjaeagung, Sumurpecung, Kec. Serang, Kota Serang, Banten 42122</p>
            <p class="mt-3"><strong>Phone:</strong> <span>0254221764</span></p>
            <p><strong>Email:</strong> <span>diskominfoserangkota@gmail.com</span></p>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-3 footer-links">
          ...
          <ul>
            ...
            <li><i class="bi bi-chevron-right"></i> <a href="https://serangkota.go.id/">Smart city Serang Kota</a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="https://serangkota.go.id/">Pemerintahan Serang Kota</a></li>
          </ul>
        </div>
    ...
    <div class="container copyright text-center mt-4">
      <p>
        © <span>Copyright</span> 
        <span>2019 - 2024 Sistem Informasi Kota Serang Dalam Angka version 3.0</span>
      </p>
      <div class="credits">
        Designed by <a href="https://kominfo.serangkota.go.id/ ">IT E-gov Diskominfo Kota Serang</a>
      </div>
    </div>
  </footer>
